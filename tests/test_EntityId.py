...
class entityid_test(unittest.TestCase):
    ...
    def test_EntityId(self):
        ...
        self.assertTrue(
            ok, "EntityId with invalid string did not raise a ValueError as expected"
        )
        ...
        self.assertTrue(
            ok, "EntityId with invalid type did not raise a ValueError as expected"
        )
        ...
        self.assertTrue(
            ok,
            "EntityId with too many arguments did not raise a ValueError as expected",
        )
