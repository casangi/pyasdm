...
class entity_test(unittest.TestCase):
    ...
    def test_Entity(self):
        ...
        eALMA2 = Entity(
            eALMA.getEntityId(),
            eALMA.getEntityIdEncrypted(),
            eALMA.getEntityTypeName(),
            eALMA.getEntityVersion(),
            eALMA.getInstanceVersion(),
        )
        ...
        self.assertTrue(
            eVLA2.getEntityId().equals(EntityId("uid://evla/sdm/X1465236651400"))
        )
