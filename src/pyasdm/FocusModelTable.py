...
class FocusModelTable(Representable):
    """
    ...
    focusModelId int refers to a collection of rows in the table.
    ...
    # A list to store the FocusModelRow instances
    _privateRows = []
    ...
    def __init__(self, container):
        """
        Create a FocusModelTable attached to container, which must be a ASDM instance
    ...
    def add(self, newrow):
        ...
        homologues in newrow.  If a row is found return that row else autoincrement newrow.focusModelId,
        ...
        aRow = self.lookup(
            ...
            newrow.getNumCoeff(),
            newrow.getCoeffName(),
            newrow.getCoeffFormula(),
            newrow.getCoeffVal(),
            newrow.getAssocNature(),
            newrow.getAssocFocusModelId(),
        )
        if aRow is not None:
            return aRow

        key = FocusModelTable.Key(newrow.getAntennaId())
    ...
    def newRow(
        ...
        """
        Create a new FocusModelRow. The new row is not added to this table, but it does know about it.
    ...
    def _checkAndAdd(self, newrow):
        ...
        if (
            self.getRowByKey(newrow.getAntennaId(), newrow.getFocusModelId())
            is not None
        ):
    ...
    def get(self):
        """
        Get all rows as an array of FocusModelRow
        """
    ...
    def getRowByFocusModelId(self, focusModelId):
        """
        ...
        @param focusModelId contains the value of
    ...
    def fromXML(self, xmlstr):
        ...
        if (
            ...
            raise ConversionException(
                "XML is not from a the expected table", "FocusModelTable."
            )
        ...
        if (not tabdom.hasAttributes()) or (
            ...
            raise ConversionException(
                "schemaVersion not found in XML", "FocusModelTable"
            )
        ...
        for thisNode in tabdom.childNodes:
            ...
            if nodeName == "Entity":
                ...
                try:
                    ...
                    # reraise it as a ConversionException
                    raise ConversionException(str, "FocusModelTable") from None
    ...
    def setFromXMLFile(self, directory):
        ...
        if xmlstr is None:
            raise ConversionException("FocusModel.xml is empty", "FocusModelTable")
    ...
    def toFile(self, directory):
        ...
        of this (_fileAsBin=True) will be saved in a file 'FocusModel.bin' or an
        XML representation (_fileAsBin==False) will be saved in a file 'FocusModel.xml'.
