...
class DopplerTable:
    ...
    Attributes:
        ...
        dopplerId (int): identifies a collection of rows in the table. auto-incrementable, key.



        sourceId (int): refers to a collection of rows in SourceTable. key.
    ...
    def toXML(self):
        ...
        result += '\n<DopplerTable xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:dpplr="http://Alma/XASDM/DopplerTable" xsi:schemaLocation="http://Alma/XASDM/DopplerTable http://almaobservatory.org/XML/XASDM/4/DopplerTable.xsd" schemaVersion="4" schemaRevision="-1">'
        result += "\n " + self._entity.toXML()
        ...
        for thisNode in tabdom.childNodes:
            ...
            if nodeName == "Entity":
                ...
                try:
                    ...
                    raise ConversionException(msg, "DopplerTable") from None
    ...
    def setFromMIME(self, byteStream):
        ...
        if numRows == -1:
            ...
            numRows = self._container.getExpectedTableSize("Doppler")
        ...
        try:
            for i in range(numRows):
                self.checkAndAdd(
                    DopplerRow.fromBin(eis, self, attributesSeq),
