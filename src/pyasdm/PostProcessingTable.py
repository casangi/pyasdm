...
class PostProcessingTable:
    ...
    def toXML(self):
        ...
        result += '\n<PostProcessingTable xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:postproc="http://Alma/XASDM/PostProcessingTable" xsi:schemaLocation="http://Alma/XASDM/PostProcessingTable http://almaobservatory.org/XML/XASDM/4/PostProcessingTable.xsd" schemaVersion="4" schemaRevision="-1">'
        result += "\n " + self._entity.toXML()
        ...
        for thisNode in tabdom.childNodes:
            ...
            if nodeName == "Entity":
                ...
                try:
                    ...
                    raise ConversionException(msg, "PostProcessingTable") from None
    ...
    def setFromMIME(self, byteStream):
        ...
        if numRows == -1:
            ...
            numRows = self._container.getExpectedTableSize("PostProcessing")
        ...
        try:
            for i in range(numRows):
                self.checkAndAdd(
                    PostProcessingRow.fromBin(eis, self, attributesSeq),
