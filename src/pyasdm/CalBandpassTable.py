...
class CalBandpassTable:
    ...
    def setFromMIME(self, byteStream):
        ...
        if numRows == -1:
            ...
            numRows = self._container.getExpectedTableSize("CalBandpass")
        ...
        try:
            for i in range(numRows):
                self.checkAndAdd(
                    CalBandpassRow.fromBin(eis, self, attributesSeq),
            ...
            raise ConversionException(msg, "CalBandpassTable") from None
