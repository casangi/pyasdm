...
class TotalPowerTable(Representable):
    """
    ...
    # A list to store the TotalPowerRow instances
    _privateRows = []
    ...
    def __init__(self, container):
        """
        Create a TotalPowerTable attached to container, which must be a ASDM instance
    ...
    def newRow(
        ...
        """
        Create a new TotalPowerRow. The new row is not added to this table, but it does know about it.
    ...
    def _checkAndAdd(self, newrow):
        ...
        rowKey = TotalPowerTable.Key(
            newrow.getConfigDescriptionId(), newrow.getFieldId()
        )
    ...
    def get(self):
        """
        Get all rows as a list of TotalPowerRow
        """
    ...
    def getByContext(self, configDescriptionId, fieldId):
        ...
        """
        thisKey = TotalPowerTable.Key(configDescriptionId, fieldId)
    ...
    def getRowByKey(self, time, configDescriptionId, fieldId):
        ...
        """
        rowKey = TotalPowerTable.Key(configDescriptionId, fieldId)
        result = None
    ...
    def fromXML(self, xmlstr):
        ...
        if (
            ...
            raise ConversionException(
                "XML is not from a the expected table", "TotalPowerTable."
            )
        ...
        if (not tabdom.hasAttributes()) or (
            ...
            raise ConversionException(
                "schemaVersion not found in XML", "TotalPowerTable"
            )
        ...
        for thisNode in tabdom.childNodes:
            ...
            if nodeName == "Entity":
                ...
                try:
                    ...
                    # reraise it as a ConversionException
                    raise ConversionException(str, "TotalPowerTable") from None
    ...
    def setFromXMLFile(self, directory):
        ...
        if xmlstr is None:
            raise ConversionException("TotalPower.xml is empty", "TotalPowerTable")
    ...
    def toFile(self, directory):
        ...
        of this (_fileAsBin=True) will be saved in a file 'TotalPower.bin' or an
        XML representation (_fileAsBin==False) will be saved in a file 'TotalPower.xml'.
