...
class ModulationTable:
    ...
    def toXML(self):
        ...
        result += '\n<ModulationTable xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:modlatn="http://Alma/XASDM/ModulationTable" xsi:schemaLocation="http://Alma/XASDM/ModulationTable http://almaobservatory.org/XML/XASDM/4/ModulationTable.xsd" schemaVersion="4" schemaRevision="-1">'
        result += "\n " + self._entity.toXML()
    ...
    def setFromMIME(self, byteStream):
        ...
        if numRows == -1:
            ...
            numRows = self._container.getExpectedTableSize("Modulation")
        ...
        try:
            for i in range(numRows):
                self.checkAndAdd(
                    ModulationRow.fromBin(eis, self, attributesSeq),
            ...
            raise ConversionException(msg, "ModulationTable") from None
