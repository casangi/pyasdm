...
class CalAppPhaseTable:
    ...
    def setFromMIME(self, byteStream):
        ...
        if numRows == -1:
            ...
            numRows = self._container.getExpectedTableSize("CalAppPhase")
        ...
        try:
            for i in range(numRows):
                self.checkAndAdd(
                    CalAppPhaseRow.fromBin(eis, self, attributesSeq),
            ...
            raise ConversionException(msg, "CalAppPhaseTable") from None
