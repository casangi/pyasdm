...
class SquareLawDetectorTable:
    ...
    Attributes:
        ...
        squareLawDetectorId (Tag): identifies a unique row in the table. auto-incrementable, key.





        numBand (int): the number of bands.
    ...
    def checkAndAdd(self, x, skipUniquenessCheck=False):
        ...
        if not skipUniquenessCheck:
            if self.getRowByKey(x.getSquareLawDetectorId()) is not None:
                raise DuplicateKey(
                    "Duplicate key exception in ", "SquareLawDetectorTable"
                )
        ...
        for thisNode in tabdom.childNodes:
            ...
            if nodeName == "Entity":
                ...
                try:
                    ...
                    raise ConversionException(msg, "SquareLawDetectorTable") from None
    ...
    def setFromMIME(self, byteStream):
        ...
        try:
            for i in range(numRows):
                self.checkAndAdd(
                    SquareLawDetectorRow.fromBin(eis, self, attributesSeq),
