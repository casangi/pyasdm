...
class CalFocusModelTable:
    ...
    def toXML(self):
        ...
        result += '\n<CalFocusModelTable xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:clfcsm="http://Alma/XASDM/CalFocusModelTable" xsi:schemaLocation="http://Alma/XASDM/CalFocusModelTable http://almaobservatory.org/XML/XASDM/4/CalFocusModelTable.xsd" schemaVersion="4" schemaRevision="-1">'
        result += "\n " + self._entity.toXML()
    ...
    def setFromMIME(self, byteStream):
        ...
        if numRows == -1:
            ...
            numRows = self._container.getExpectedTableSize("CalFocusModel")
        ...
        try:
            for i in range(numRows):
                self.checkAndAdd(
                    CalFocusModelRow.fromBin(eis, self, attributesSeq),
            ...
            raise ConversionException(msg, "CalFocusModelTable") from None
