...
class CalFocusModelTable(Representable):
    """
    ...
    polarizationType PolarizationType identifies the polarization type for which this focus model is valid.
    ...
    reducedChiSquared double  a measure of the quality of the least-square fit.
    ...
    # A list to store the CalFocusModelRow instances
    _privateRows = []
    ...
    @staticmethod
    def Key(antennaName, receiverBand, polarizationType, calDataId, calReductionId):
        """
    ...
    def __init__(self, container):
        """
        Create a CalFocusModelTable attached to container, which must be a ASDM instance
    ...
    def newRow(
        ...
        """
        Create a new CalFocusModelRow. The new row is not added to this table, but it does know about it.
    ...
    def get(self):
        """
        Get all rows as an array of CalFocusModelRow
        """
    ...
    def fromXML(self, xmlstr):
        ...
        if (
            ...
            raise ConversionException(
                "XML is not from a the expected table", "CalFocusModelTable."
            )
        ...
        if (not tabdom.hasAttributes()) or (
            ...
            raise ConversionException(
                "schemaVersion not found in XML", "CalFocusModelTable"
            )
        ...
        for thisNode in tabdom.childNodes:
            ...
            if nodeName == "Entity":
                ...
                try:
                    ...
                    # reraise it as a ConversionException
                    raise ConversionException(str, "CalFocusModelTable") from None
    ...
    def setFromXMLFile(self, directory):
        ...
        if xmlstr is None:
            raise ConversionException(
                "CalFocusModel.xml is empty", "CalFocusModelTable"
            )
    ...
    def toFile(self, directory):
        ...
        of this (_fileAsBin=True) will be saved in a file 'CalFocusModel.bin' or an
        XML representation (_fileAsBin==False) will be saved in a file 'CalFocusModel.xml'.
