...
class HolographyTable(Representable):
    """
    ...
    holographyId Tag identifies a unique row in the table.
    ...
    # A list to store the HolographyRow instances
    _privateRows = []
    ...
    def __init__(self, container):
        """
        Create a HolographyTable attached to container, which must be a ASDM instance
    ...
    def add(self, newrow):
        ...
        homologues in newrow.  If a row is found return that row else autoincrement newrow.holographyId,
        ...
        # Autoincrement holographyId, same as the number of this row in the table
        newrow.setHolographyId(Tag(size(), TagType.Holography))
    ...
    def newRow(self, distance, focus, numCorr, type):
        """
        Create a new HolographyRow. The new row is not added to this table, but it does know about it.
    ...
    def _checkAndAdd(self, newrow):
        ...
        if self.getRowByKey(newrow.getHolographyId()) is not None:
    ...
    def get(self):
        """
        Get all rows as an array of HolographyRow
        """
    ...
    def fromXML(self, xmlstr):
        ...
        if (
            ...
            raise ConversionException(
                "XML is not from a the expected table", "HolographyTable."
            )
        ...
        if (not tabdom.hasAttributes()) or (
            ...
            raise ConversionException(
                "schemaVersion not found in XML", "HolographyTable"
            )
        ...
        for thisNode in tabdom.childNodes:
            ...
            if nodeName == "Entity":
                ...
                try:
                    ...
                    # reraise it as a ConversionException
                    raise ConversionException(str, "HolographyTable") from None
    ...
    def setFromXMLFile(self, directory):
        ...
        if xmlstr is None:
            raise ConversionException("Holography.xml is empty", "HolographyTable")
    ...
    def toFile(self, directory):
        ...
        of this (_fileAsBin=True) will be saved in a file 'Holography.bin' or an
        XML representation (_fileAsBin==False) will be saved in a file 'Holography.xml'.
