...
class CalAmpliTable:
    ...
    def toXML(self):
        ...
        result += '\n<CalAmpliTable xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:clmpl="http://Alma/XASDM/CalAmpliTable" xsi:schemaLocation="http://Alma/XASDM/CalAmpliTable http://almaobservatory.org/XML/XASDM/4/CalAmpliTable.xsd" schemaVersion="4" schemaRevision="-1">'
        result += "\n " + self._entity.toXML()
    ...
    def setFromMIME(self, byteStream):
        ...
        if numRows == -1:
            ...
            numRows = self._container.getExpectedTableSize("CalAmpli")
        ...
        try:
            for i in range(numRows):
                self.checkAndAdd(
                    CalAmpliRow.fromBin(eis, self, attributesSeq),
            ...
            raise ConversionException(msg, "CalAmpliTable") from None
