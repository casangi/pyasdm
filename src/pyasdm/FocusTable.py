...
class FocusTable:
    ...
    def toXML(self):
        ...
        result += '\n<FocusTable xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:focus="http://Alma/XASDM/FocusTable" xsi:schemaLocation="http://Alma/XASDM/FocusTable http://almaobservatory.org/XML/XASDM/4/FocusTable.xsd" schemaVersion="4" schemaRevision="-1">'
        result += "\n " + self._entity.toXML()
    ...
    def setFromMIME(self, byteStream):
        ...
        if numRows == -1:
            ...
            numRows = self._container.getExpectedTableSize("Focus")
        ...
        try:
            for i in range(numRows):
                self.checkAndAdd(
                    FocusRow.fromBin(eis, self, attributesSeq), self._checkRowUniqueness
                )
            ...
            raise ConversionException(msg, "FocusTable") from None
