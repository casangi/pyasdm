...
class HistoryTable:
    ...
    def toXML(self):
        ...
        result += '\n<HistoryTable xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:histry="http://Alma/XASDM/HistoryTable" xsi:schemaLocation="http://Alma/XASDM/HistoryTable http://almaobservatory.org/XML/XASDM/4/HistoryTable.xsd" schemaVersion="4" schemaRevision="-1">'
        result += "\n " + self._entity.toXML()
    ...
    def setFromMIME(self, byteStream):
        ...
        if numRows == -1:
            ...
            numRows = self._container.getExpectedTableSize("History")
        ...
        try:
            for i in range(numRows):
                self.checkAndAdd(
                    HistoryRow.fromBin(eis, self, attributesSeq),
            ...
            raise ConversionException(msg, "HistoryTable") from None
