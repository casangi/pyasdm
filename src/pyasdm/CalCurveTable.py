...
class CalCurveTable(Representable):
    """
    ...
    # A list to store the CalCurveRow instances
    _privateRows = []
    ...
    @staticmethod
    def Key(atmPhaseCorrection, typeCurve, receiverBand, calDataId, calReductionId):
        """
    ...
    def __init__(self, container):
        """
        Create a CalCurveTable attached to container, which must be a ASDM instance
    ...
    def newRow(
        ...
        """
        Create a new CalCurveRow. The new row is not added to this table, but it does know about it.
    ...
    def get(self):
        """
        Get all rows as an array of CalCurveRow
        """
    ...
    def fromXML(self, xmlstr):
        ...
        if not xmldom.hasChildNodes() or xmldom.firstChild.nodeName != "CalCurveTable":
            raise ConversionException(
                "XML is not from a the expected table", "CalCurveTable."
            )
        ...
        if (not tabdom.hasAttributes()) or (
            ...
            raise ConversionException("schemaVersion not found in XML", "CalCurveTable")
        ...
        for thisNode in tabdom.childNodes:
            ...
            if nodeName == "Entity":
                ...
                try:
                    ...
                    # reraise it as a ConversionException
                    raise ConversionException(str, "CalCurveTable") from None
    ...
    def setFromXMLFile(self, directory):
        ...
        if xmlstr is None:
            raise ConversionException("CalCurve.xml is empty", "CalCurveTable")
    ...
    def toFile(self, directory):
        ...
        of this (_fileAsBin=True) will be saved in a file 'CalCurve.bin' or an
        XML representation (_fileAsBin==False) will be saved in a file 'CalCurve.xml'.
