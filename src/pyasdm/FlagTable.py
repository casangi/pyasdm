...
class FlagTable:
    ...
    def toXML(self):
        ...
        result += '\n<FlagTable xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:flag="http://Alma/XASDM/FlagTable" xsi:schemaLocation="http://Alma/XASDM/FlagTable http://almaobservatory.org/XML/XASDM/4/FlagTable.xsd" schemaVersion="4" schemaRevision="-1">'
        result += "\n " + self._entity.toXML()
        ...
        for thisNode in tabdom.childNodes:
            ...
            if nodeName == "Entity":
                ...
                try:
                    ...
                    raise ConversionException(msg, "FlagTable") from None
    ...
    def setFromMIME(self, byteStream):
        ...
        if numRows == -1:
            ...
            numRows = self._container.getExpectedTableSize("Flag")
        ...
        try:
            for i in range(numRows):
                self.checkAndAdd(
                    FlagRow.fromBin(eis, self, attributesSeq), self._checkRowUniqueness
                )
