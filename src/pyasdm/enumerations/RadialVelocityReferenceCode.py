...
class RadialVelocityReferenceCode:
    ...
    def name(radialVelocityReferenceCode):
        """
        Returns the string form of the RadialVelocityReferenceCode
        """
        return radialVelocityReferenceCode.getName()

    @staticmethod
    def toString(radialVelocityReferenceCode):
        """
        Equivalent to the name method
        """
        return RadialVelocityReferenceCode.name(radialVelocityReferenceCode)
