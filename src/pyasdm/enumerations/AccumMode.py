...
class AccumMode:
    ...
    def __eq__(self, other):
        """
        Returns True if other is a AccumMode and its value is the same as this one.
        """
        return isinstance(other, AccumMode) and (other.getValue() == self.getValue())
