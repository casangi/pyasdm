...
class SyscalMethod:
    ...
    def __eq__(self, other):
        """
        Returns True if other is a SyscalMethod and its value is the same as this one.
        """
        return isinstance(other, SyscalMethod) and (other.getValue() == self.getValue())
