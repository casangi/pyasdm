...
class SpectralResolutionType:
    ...
    def name(spectralResolutionType):
        """
        Returns the string form of the SpectralResolutionType
        """
        return spectralResolutionType.getName()

    @staticmethod
    def toString(spectralResolutionType):
        """
        Equivalent to the name method
        """
        return SpectralResolutionType.name(spectralResolutionType)
