...
class PrimaryBeamDescription:
    ...
    def name(primaryBeamDescription):
        """
        Returns the string form of the PrimaryBeamDescription
        """
        return primaryBeamDescription.getName()

    @staticmethod
    def toString(primaryBeamDescription):
        """
        Equivalent to the name method
        """
        return PrimaryBeamDescription.name(primaryBeamDescription)
