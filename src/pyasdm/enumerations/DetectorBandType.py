...
class DetectorBandType:
    ...
    def __eq__(self, other):
        """
        Returns True if other is a DetectorBandType and its value is the same as this one.
        """
        return isinstance(other, DetectorBandType) and (
