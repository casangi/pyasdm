...
class SidebandProcessingMode:
    ...
    def name(sidebandProcessingMode):
        """
        Returns the string form of the SidebandProcessingMode
        """
        return sidebandProcessingMode.getName()

    @staticmethod
    def toString(sidebandProcessingMode):
        """
        Equivalent to the name method
        """
        return SidebandProcessingMode.name(sidebandProcessingMode)
